...
function hiToast(text, options) {
	...
	if (options.thems) {
		thems_markup = 'hiToast-' + options.thems;
	}

	var html = $('<div class="hiToast  ' + thems_markup + '" style="padding: 5px 15px;z-index: 999;border-radius: 4px;position: fixed;background-color: rgba(0,0,0,.7);">' + text + '</div>').fadeIn(options['fade-time']);
